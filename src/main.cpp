        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            if (prev_size < 2)
            {
              ...
              //      /                              | /
              //     /                               |/ car_yaw
              //    . (prev_car_x, prev_car_y)        ---- x
              //list two points that make the path tangent to the car
            ...
            // transform to local car's coordinates (starting state x,y,yaw = 0, 0, 0 in local car's coordinate)
            ...
            s.set_points(ptsx, ptsy); // 5 points : (ref_x,ref_y) , (ref_x_prev,ref_y_prev), (next_wp0[0], next_wp0[1]), (next_wp1[0], next_wp1[1]), (next_wp2[0], next_wp2[1]) 
